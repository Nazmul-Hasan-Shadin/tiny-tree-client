...
const Cart = () => {
  ...
  const price = cartProducts.reduce((accumalator, product) => {
    if (product.price && product.selectedQuantity) {
      return accumalator + product.price * product.selectedQuantity! ;
    }
    return accumalator;
  }, 0);
    ...
    <div className="container mx-auto mt-10">
      <div className="sm:flex shadow-md my-10">
        <div className="  w-full  sm:w-3/4 bg-white px-10 py-10">
          ...
          <Link
           to={'/'}
            className="flex font-semibold text-green-500 text-sm mt-10"
          >
            <svg
        ...
        >
          <h1 className="font-semibold text-2xl border-b pb-8 text-primary-green">
            Order Summary
          </h1>
